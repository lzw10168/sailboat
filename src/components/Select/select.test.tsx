...
describe('test Select component', () => {
  ...
  it('Select in multiple mode should works fine', () => {
    ...
    // add tags
    expect(container.querySelectorAll('.sailboat-tag').length).toEqual(1);
    //remove placeholder
    ...
    expect(container.querySelectorAll('.sailboat-tag').length).toEqual(2);
    //reclick 2nd item
    fireEvent.click(secondItem);
    // remove acitve class
    ...
    //remove all tags
    expect(container.querySelectorAll('.sailboat-tag').length).toEqual(0);
